 ...
 * @version 0.0
 ******************************************************************************
 * an option to switch off direct rounding was add,
 * two bugs in pow_*() functions were solved.
 * @author Nikita Panov
 * @version 1.0
 * 
 */ 
public class RMath
{
 ...
 static boolean simpleRounding = false; // nvp

  static {
    Zero = 0.0;
    NegZero = (-1.0)*(0.0);
//    System.out.println("IAMath simpleRounding:" + simpleRounding);
  }
    ...
    if (x < 0)
      ...
      if (x >= 1)
        ...
        return 1.0;
         ...
         //return  exp_lo(mul_lo(y,log_hi(x)));  // orig -- this is a bug!!!
...
//        return  exp_hi(mul_hi(y,log_lo(x))); // orig -- a bug is here
